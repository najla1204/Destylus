...
import { ArrowLeft, Plus, Trash2, Save, HardHat } from "lucide-react";
...
const defaultEntries: LaborEntry[] = [
    { id: "1", category: "Mason", count: "", salary: "" },
    { id: "2", category: "Male Workers", count: "", salary: "" },
    { id: "3", category: "Female Workers", count: "", salary: "" },
    { id: "4", category: "Stone Cutter", count: "", salary: "" },
    { id: "5", category: "Helper", count: "", salary: "" },
    { id: "6", category: "Extra Employees (Male)", count: "", salary: "" },
    { id: "7", category: "Extra Employees (Female)", count: "", salary: "" },
];

export default function LaborEntryPage() {
    const params = useParams();
    const router = useRouter();
    const [entries, setEntries] = useState<LaborEntry[]>(defaultEntries);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Simulate API call
        setTimeout(() => {
            alert("Labour data submitted successfully!");
            setSubmitting(false);
    ...
    return (
        <div className="flex flex-col gap-6 max-w-5xl mx-auto">
            <div className="flex flex-col gap-4 border-b border-gray-700 pb-6">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-foreground">Labour Work Entry</h1>
                    <p className="text-muted">Enter daily manpower and verify salary calculations.</p>
                </div>
            </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left text-sm">
                            ...
                            <tfoot className="bg-surface/50 font-bold text-foreground">
                                <tr>
                                    <td className="p-4 text-primary">+ Add Work (Optional)</td>
